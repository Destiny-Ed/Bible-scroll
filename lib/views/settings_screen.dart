...
class SettingsScreen extends StatelessWidget {
        ...
        children: [
          ...
          _buildSettingsCard([
            ...
            _buildSettingsTile(context, 'Terms of Service', Icons.description_outlined),
             _buildSettingsTile(context, 'App Version', Icons.info_outline, trailing: '1.0.0'),
          ]),
        ],
      ),
    );
  ...
  Widget _buildSettingsTile(BuildContext context, String title, IconData icon, {String? trailing}) {
    return ListTile(
       leading: Icon(icon),
      title: Text(title),
